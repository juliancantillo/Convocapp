...
CREATE TABLE IF NOT EXISTS `applicant` (
  ...
  `id_convocatory` int(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `municipio` (
  ...
  `nombreMunicipio` varchar(128) NOT NULL,
...
(3, '', 'mauro', '81dc9bdb52d04dc20036dbd8313ed055', '', '', '', '', '', '', 0, '2014-11-05 06:40:14', NULL),
(4, '123321', 'pedro', 'd8578edf8458ce06fbc5bb76a58c5ca4', '', 'pedro', 'castro', 'calle 32 # 343-2', '1424564', '', 1, '2014-11-05 14:01:04', NULL);
...
ALTER TABLE `convocatory`
 ADD PRIMARY KEY (`identificacion`), ADD UNIQUE KEY `name` (`name`);
